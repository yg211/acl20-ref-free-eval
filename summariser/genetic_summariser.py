...
class GeneticSummariser():
    def __init__(self, fitness_func, max_sum_len=100, max_round=15, max_pop_size=500, temperature=0.5, mutation_rate=0.4):
